...
/**
 * forkwait_exec - executes commands by first forking a child process
...
void forkwait_exec(char **commands, char **path_array, char **env,
		    char *NAME, char *usr_input)
{
	pid_t pid;
